...
// Define quarters to fetch - focusing on one year of data with quarterly breakdown
const QUARTERS = [
  // Yearly data - comprehensive coverage
  //comleted -removing
  ...
  //{ name: 'Hot Year', sort: 'hot', limit: 3000, fetchAllTime: false, maxAgeHours: 24 * 365 },
  { name: 'Best Year', sort: 'best' as any, limit: 3000, fetchAllTime: false, maxAgeHours: 24 * 365 },
  { name: 'Controversial Year', sort: 'controversial' as any, limit: 3000, fetchAllTime: false, maxAgeHours: 24 * 365 },
  { name: 'Rising Year', sort: 'rising' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 365 },
  
  // Quarterly data for more granular coverage
  { name: 'New Q1 (Months 1-3)', sort: 'new', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 90 },
  { name: 'New Q2 (Months 4-6)', sort: 'new', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 180, minAgeHours: 24 * 90 },
  { name: 'New Q3 (Months 7-9)', sort: 'new', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 270, minAgeHours: 24 * 180 },
  { name: 'New Q4 (Months 10-12)', sort: 'new', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 365, minAgeHours: 24 * 270 },
  
  // Top posts by quarter
  { name: 'Top Q1 (Months 1-3)', sort: 'top', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 90 },
  { name: 'Top Q2 (Months 4-6)', sort: 'top', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 180, minAgeHours: 24 * 90 },
  { name: 'Top Q3 (Months 7-9)', sort: 'top', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 270, minAgeHours: 24 * 180 },
  { name: 'Top Q4 (Months 10-12)', sort: 'top', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 365, minAgeHours: 24 * 270 },
  
  // Hot posts by quarter
  { name: 'Hot Q1 (Months 1-3)', sort: 'hot', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 90 },
  { name: 'Hot Q2 (Months 4-6)', sort: 'hot', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 180, minAgeHours: 24 * 90 },
  { name: 'Hot Q3 (Months 7-9)', sort: 'hot', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 270, minAgeHours: 24 * 180 },
  { name: 'Hot Q4 (Months 10-12)', sort: 'hot', limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 365, minAgeHours: 24 * 270 },
  
  // Best posts by quarter
  { name: 'Best Q1 (Months 1-3)', sort: 'best' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 90 },
  { name: 'Best Q2 (Months 4-6)', sort: 'best' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 180, minAgeHours: 24 * 90 },
  { name: 'Best Q3 (Months 7-9)', sort: 'best' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 270, minAgeHours: 24 * 180 },
  { name: 'Best Q4 (Months 10-12)', sort: 'best' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 365, minAgeHours: 24 * 270 },
  
  // Controversial posts by quarter
  { name: 'Contr Q1 (Months 1-3)', sort: 'controversial' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 90 },
  { name: 'Contr Q2 (Months 4-6)', sort: 'controversial' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 180, minAgeHours: 24 * 90 },
  { name: 'Contr Q3 (Months 7-9)', sort: 'controversial' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 270, minAgeHours: 24 * 180 },
  { name: 'Contr Q4 (Months 10-12)', sort: 'controversial' as any, limit: 1000, fetchAllTime: false, maxAgeHours: 24 * 365, minAgeHours: 24 * 270 },
  
  // Rising posts by quarter (using smaller limit as rising posts are more time-sensitive)
  { name: 'Rising Q1 (Months 1-3)', sort: 'rising' as any, limit: 300, fetchAllTime: false, maxAgeHours: 24 * 90 },
  { name: 'Rising Q2 (Months 4-6)', sort: 'rising' as any, limit: 300, fetchAllTime: false, maxAgeHours: 24 * 180, minAgeHours: 24 * 90 },
  { name: 'Rising Q3 (Months 7-9)', sort: 'rising' as any, limit: 300, fetchAllTime: false, maxAgeHours: 24 * 270, minAgeHours: 24 * 180 },
  { name: 'Rising Q4 (Months 10-12)', sort: 'rising' as any, limit: 300, fetchAllTime: false, maxAgeHours: 24 * 365, minAgeHours: 24 * 270 }
] as const;
...
async function fetchResilient(): Promise<void> {
  ...
  console.log('\n🚀 STARTING RESILIENT ASKSF DATA FETCH');
  console.log('═════════════════════════════════════════════════════');
  console.log(`📊 Processing ${QUARTERS.length} quarters of Reddit data from r/${SUBREDDIT}`);
  console.log('═════════════════════════════════════════════════════\n');
