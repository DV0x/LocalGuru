...
import { Mic, Loader2, Send, Paperclip } from "lucide-react";
      ...
      <div className="relative flex items-center">
        <div className="relative flex-1 bg-[#202123] rounded-xl border border-[#444654]/50 shadow-sm overflow-hidden">
          <Input
            ...
            className="border-0 bg-transparent text-white h-14 pl-4 pr-24 text-base focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-gray-500"
            disabled={isLoading}
          />
