  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-3xl mx-auto">
      <div className="relative flex items-center">
        <div className="relative flex-1 bg-[#202123] rounded-lg border border-[#444654] shadow-sm overflow-hidden">
          <Input
            type="text"
            placeholder="Ask about travel tips, hidden gems, local insights..."
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            className="border-0 bg-transparent text-white h-14 pl-4 pr-24 text-base focus-visible:ring-0 focus-visible:ring-offset-0"
            disabled={isLoading}
          />
