...
export default function Home() {
  ...
  return (
    <main className={`flex min-h-screen flex-col items-center ${hasResults ? 'pt-12 pb-20' : 'justify-center'} p-4 md:p-8 lg:p-12 bg-[#0f0f0f]`}>
      <div className={`w-full max-w-3xl mx-auto ${hasResults ? 'mb-8' : ''} text-center`}>
        <div className="flex justify-center mb-4">
          <div className="bg-primary/10 p-3 rounded-full">
            <Compass className="h-8 w-8 text-primary" />
          </div>
