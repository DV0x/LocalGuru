    ...
    <div className="container mx-auto py-10 px-4">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Test the semantic search functionality using Supabase pgvector
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-4">
            <div className="flex gap-2">
              <Input
                ...
                placeholder="Enter a travel query..."
                className="flex-1"
              />
              <Button 
            ...
            {vectorResult && (
              <div className="mt-4">
                ...
                {vectorResult.success ? (
                  <div>
                    {vectorResult.data.length > 0 ? (
                      <div className="space-y-4">
                        {vectorResult.data.map((item: any, index: number) => (
                      ...
                      <p className="text-amber-500">No results found. Make sure you've ingested Reddit data first.</p>
                    )}
                  </div>
                ) : (
