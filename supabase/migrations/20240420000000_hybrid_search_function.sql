-- Migration to implement hybrid search function
-- This combines keyword search with vector similarity for improved results
...
BEGIN
  ...
  -- This allows runtime control of HNSW search parameters
...
COMMENT ON FUNCTION public.hybrid_search IS 'Hybrid search function that combines PostgreSQL full-text search with vector similarity search for improved relevance. Uses a multi-step approach: text pre-filtering, vector scoring, and combined ranking.';
